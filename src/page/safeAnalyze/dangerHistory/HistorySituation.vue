                    ...
                    <el-card shadow="hover">
                        ...
                        <div>
                            ...
                            <i
                                ...
                                v-if="
                                    (brakeover > 0) & (brakeover !== Infinity)
                                "
                            ></i>
                            <i
                    ...
                    <el-card shadow="hover">
                        ...
                        <div>
                            ...
                            <i
                                ...
                                v-if="
                                    (accelerateover > 0) &
                                    (accelerateover !== Infinity)
                                "
                            ></i>
                            <i
                                class="el-icon-caret-bottom"
                                v-if="accelerateover < 0"
                            ></i>
                            <i class="el-icon-minus" v-if="accelerateover == 0">
                            </i
                        ...
                        <div>
                            ...
                            <i
                                ...
                                v-if="accelerateon < 0"
                            ></i>
                            <i class="el-icon-minus" v-if="accelerateon == 0">
                            </i
                        ...
                        <div>
                            <div>
                                ...
                                <i
                                    ...
                                    v-if="
                                        (overspeedover > 0) &
                                        (overspeedover !== Infinity)
                                    "
                                ></i>
                                <i
                                    class="el-icon-caret-bottom"
                                    v-if="overspeedover < 0"
                                ></i>
                                <i
                                    class="el-icon-minus"
                                    v-if="overspeedover == 0"
...
export default {
    data() {
        return {
            ...
            tableHistoryEvents2: [
                {
                    eventsScope: "城内",
                    eventsScopeVolume: "1092",
                },
                {
                    eventsScope: "城外",
                    eventsScopeVolume: "90",
                },
            ],
        };
    },
    ...
    methods: {
        ...
        drawChartEvents1() {
            var chartDom = document.getElementById("eventsChart1");
            var myChart = echarts.init(chartDom);
            var option = {
                title: {
                    zlevel: 0,
        ...
        calculateData(timestamp) {
            ...
            this.historySituationGet(timestamp - 86400000).then((res) => {
                ...
                this.brakeon =
                    (this.brakenum - yesterdaybrake) / yesterdaybrake;
