...
const staticRoute = [
  ...
  },
  {
    path: '/login',
    name: 'login',
    component: () => (envConfig.type === 'pubNet' ? import('../page/loginPub') : import('../page/login')),
    ...
    children: [
      {
        path: '',
        name: 'monitor',
        component: () => import(/* webpackChunkName: 'home' */ '../page/home/monitorMap'),
        meta: {
          keepAlive: false,
        },
      },
    ...
    children: [
      {
        path: '',
        name: 'trail',
        component: () => import(/* webpackChunkName: 'home' */ '../page/home/trail'),
      },
    ],
  },
  {
  ...
  },
  {
    ...
    children: [
...

      {
        path: 'dataManage',
        name: 'dataManage',
        component: () => import(/* webpackChunkName: 'example' */ '../page/example/dataManage/'),
        meta: {
          keepAlive: true,
        },
      },
